...
<head>
    ...
    <title>PN-INFOSYS ECommerce</title>
   ...
   <link rel="stylesheet" href="{{ URL::asset('assets/frontend/css/slick.css')}}">
    ...
    <!-- modernizr js -->
    <script src="{{ URL::asset('assets/frontend/js/vendor/modernizr-2.8.3.min.js')}}"></script>
</head>
                                    ...
                                    <li><a href="compare.html"><i class="fa fa-cog"></i></a>
                                        <ul class="ht-dropdown">
                                            ...
                                            @if($userid != 0)
                                                ...
                                                <li><a href="{{url('ecommerce_logout/'.$userid)}}">Logout</a></li>
                                            @endif                                   
                                        </ul>
                                    </li>                                    
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-policy">
                            <div class="icone-img">
                                <img src="{{url::asset('assets/frontend/img/icon/1.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-policy">
                            <div class="icone-img">
                                <img src="{{url::asset('assets/frontend/img/icon/2.png')}}" alt="">
                            </div>
                            <div class="policy-desc">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-policy">
                            <div class="icone-img">
                                <img src="{{url::asset('assets/frontend/img/icon/3.png')}}" alt="">
                            </div>
                            <div class="policy-desc">
                                <h3>Money Return</h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-policy">
                            <div class="icone-img">
                                <img src="{{url::asset('assets/frontend/img/icon/4.png')}}" alt="">
                            </div>
                              <div class="policy-desc">
